...
public class ArrayBasicsStrings {
     ...
     *
     * @param ss : an array of Strings with positive length
     * @return : true if all Strings in ss begins with an upper case letter, and false otherwise
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ArrayBasicsStrings.hasNoDuplicates(hasNDup2)); // should be false
        System.out.println(ArrayBasicsStrings.hasNoDuplicates(hasNDup3)); // should be true
    }
}
