...
public class TestArrayList {
    ...
    public static void main(String[] args) {
         ...
         *
         * After you complete all tests, comment out the line where we create an ArrayListInteger and
         *       uncomment out the line where we create an ArrayList<Integer>.  Do the same thing in
