...
/**
 * This class extends the finch.Robot class to incorporate functions to control the inputs and outputs
 * of the finch.Finch. It includes methods to set the values of motors and LEDs, as well
...
public class Finch extends Robot {
     ...
     *
     * @param device The letter corresponding to the finch.Hummingbird device, which much be "A", "B", or "C".
     * The letter that identifies the finch.Hummingbird device is assigned by the BlueBird Connector.
     */
     ...
     * This function overrides the function in the finch.Robot class so that results are
