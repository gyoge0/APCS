...
/**
 * This class extends the finch.Microbit class to incorporate functions to control the inputs and
 * outputs of the finch.Hummingbird Bit. It includes methods to set the values of motors and LEDs,
 * as well as methods to read the values of the sensors.
 *
 * <p>Mike Yuan and Bambi Brewer, BirdBrain Technologies LLC November 2018
 */
public class Hummingbird extends Robot {
    ...
    /**
     * This function tries to read sensor 4 (the finch.Hummingbird battery) to determine whether or
     * not the device is a finch.Hummingbird.
     */
    ...
    /**
     * getLight returns light sensor value at a given port after processing the raw sensor value
     * retrieved. The function shows a warning dialog if the inputs are not in the specified range.
     *
    ...
    /**
     * getSound returns sound sensor value at a given port after processing the raw sensor value
     * retrieved. The function shows a warning dialog if the inputs are not in the specified range.
     *
    ...
    /**
     * getDistance returns distance sensor value at a given port after processing the raw sensor
     * value retrieved. The function shows a warning dialog if the inputs are not in the specified
     * range.
     *
