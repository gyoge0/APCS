...
/**
 * This class extends the finch.Microbit class to incorporate functions to control the inputs and outputs
 * of the finch.Hummingbird Bit. It includes methods to set the values of motors and LEDs, as well
...
public class Hummingbird extends Robot {
    ...
    /** This function tries to read sensor 4 (the finch.Hummingbird battery) to determine whether or not
     * the device is a finch.Hummingbird.
     */
