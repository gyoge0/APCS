 ...
 * all its functionality from the abstract class finch.Robot. The only methods it needs here are constructors,
...
public class Microbit extends Robot {
	...
	/** This function tries to read sensor 4 (the finch.Hummingbird battery) to determine whether
     * the device is a finch.Hummingbird or a micro:bit. It returns true if the device is a micro:bit. */
