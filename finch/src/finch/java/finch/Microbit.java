...
/**
 * This class controls a micro:bit via bluetooth. It inherits almost all its functionality from the
 * abstract class finch.Robot. The only methods it needs here are constructors, which call a
 * function that checks whether or not it is a micro:bit.
 *
